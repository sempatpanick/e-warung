...
class ItemProduct extends StatefulWidget {
  ...
  const ItemProduct({Key? key, required this.index, required this.product, required this.utilsProvider, required this.cart, required this.userProv, required this.pref}) : super(key: key);
